...
public class MainActivity extends FragmentActivity{
    ...
    private void initView() {
        ...
        listFragment.add(new BeforeGameDataFragment());
        listFragment.add(new BeforeGameScoreFragment());
        listFragment.add(new BeforeGameInfoStationFragment());
    ...
    private final class MyOnPageChangeListener implements ViewPager.OnPageChangeListener
    {
        ...
        public void onPageSelected(int position) {
            ...
            KLog.e("indexFragment = "+indexFragment);
        }
