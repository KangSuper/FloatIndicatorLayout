...
public class BeforeGameScoreFragment extends Fragment {
    ...
    private final class MyOnScrollListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            isChildOnTop = (0 == firstVisibleItem);
            //KLog.e(" listview.0 = " + (0 == firstVisibleItem));
            if(MainActivity.indexFragment == 1){
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser ) {
            if((MainActivity.indexFragment == 1) &&(mainActivity!=null)&& (mainActivity.getFloatTitleLayout() != null)){
                mainActivity.getFloatTitleLayout().setIsChildOnTop(isChildOnTop);
            }
        }
    }
